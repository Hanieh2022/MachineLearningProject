...
train = train[['ID', 'log_pSat_Pa', 'MW', 'NumOfAtoms', 'NumOfO', 'NumOfC', 'NumOfConf', 'NumOfConfUsed', 'NumHBondDonors', 'hydroxyl (alkyl)', 'NumOfN', 'carboxylic acid', 'carbonylperoxynitrate', 'hydroperoxide', 'nitroester', 'carbonylperoxyacid']]
