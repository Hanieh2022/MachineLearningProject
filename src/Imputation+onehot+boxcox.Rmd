---
title: "Experiment: Imputation + one-hot encoding of 'parentspecious and box-cox transformation of 'NumOfConf'"
date: "`r Sys.Date()`"
output: pdf_document
toc: true
---
...
combined['NumOfConf_transformed'], fitted_lambda = boxcox(combined['NumOfConf'])
combined = combined.drop(columns='NumOfConf')
...
train_extracted.to_csv('../data/train_imputed_onehot_boxcox.csv', index=False)


# extract test set from combined data
test_extracted = combined_imputed[26637:]

test_extracted.to_csv('../data/test_imputed_onehot_boxcox.csv', index=False)
